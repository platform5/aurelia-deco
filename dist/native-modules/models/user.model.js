...
import { model, Model, type, validate, form, jsonify } from '../deco';
...
var UserModel = /** @class */ (function (_super) {
    ...
    UserModel.prototype.validAccountCreationToken = function (method, token, code) {
        ...
        return this.api.post(UserModel_1.baseroute + '/create-account', body).then(jsonify).then(function (element) {
            if (element.token) {
                return element;
            }
            else {
