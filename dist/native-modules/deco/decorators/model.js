...
import { DecoApi, jsonify } from '../helpers/deco-api';
import { ValidationRules, Validator, ValidationControllerFactory } from 'aurelia-validation';
import { AureliaUXFormRenderer } from 'aurelia-resources';
import { getLogger } from 'aurelia-logging';
import * as moment from 'moment';
var log = getLogger('decorators:model');
var defaultModelOptions = {
    enableStory: false
};
export var model = function (baseroute, options) {
...
var Model = /** @class */ (function () {
    ...
    Model.prototype.save = function (suffix, options) {
        ...
        }).then(jsonify).then(function (element) {
            response = Object.assign({}, element);
    ...
    Model.prototype.validate = function () {
        ...
        var validator = Container.instance.get(Validator);
