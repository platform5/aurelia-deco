...
import { initDecoState, clearDecoState, setLanguage, setRefLanguage, setCountryCode, setLanguages, setCountries, setCountry } from '../state';
import 'whatwg-fetch';
...
var DecoApi = /** @class */ (function () {
    ...
    DecoApi.prototype.init = function (store, options) {
        ...
        this.container.get(EventAggregator).subscribe('language:changed', function (language) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.store.dispatch(setLanguage, language)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        this.container.get(EventAggregator).subscribe('country:changed', function (country) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.store.dispatch(setCountry, country)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
        ...
        return this.store.dispatch(initDecoState).then(function () {
            return (options && options.languages) ? _this.store.dispatch(setLanguages, options.languages) : Promise.resolve();
        }).then(function () {
            return (options && options.language) ? _this.store.dispatch(setLanguage, options.language) : Promise.resolve();
        }).then(function () {
            return (options && options.countries) ? _this.store.dispatch(setCountries, options.countries) : Promise.resolve();
        }).then(function () {
            return (options && options.country) ? _this.store.dispatch(setCountry, options.country) : Promise.resolve();
        }).then(function () {
            return (options && options.refLanguage) ? _this.store.dispatch(setRefLanguage, options.refLanguage) : Promise.resolve();
        }).then(function () {
            _this.initDone = true;
        });
    };
