...
var log = getLogger('ad-country-selector');
...
var AdCountrySelector = /** @class */ (function () {
    ...
    AdCountrySelector.prototype.openDialog = function () {
        var _this = this;
        this.dialogService.open({ viewModel: CountriesDialog, model: { country: this.displayValue, countries: this.countriesList, prefix: this.prefix }, centerHorizontalOnly: true, overlayDismiss: true }).whenClosed(function (response) {
