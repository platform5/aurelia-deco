...
import { DecoField, DecoApi } from '../../deco';
import { inject, bindable } from 'aurelia-framework';
import { getLogger } from 'aurelia-logging';
import { DynamicDataModel } from '../../models';
var log = getLogger('components:swissdata-field');
var SwissdataField = /** @class */ (function (_super) {
    ...
    SwissdataField.prototype.processType = function () {
        ...
        if (this._type === 'dynamicmodel' || this._type === 'dynamicmodels') {
            if (Array.isArray(this.selectOptions)) {
                ...
                DynamicDataModel.use(this.options.dynamicmodel.slug).getAll().then(function (results) {
    ...
    SwissdataField.prototype.setDynamicModelOption = function () {
        if (this._type !== 'dynamicmodel' && this._type !== 'dynamicmodels')
            return;
        if (this.options.dynamicmodel && this.options.dynamicmodel instanceof DynamicDataModel)
            return;
