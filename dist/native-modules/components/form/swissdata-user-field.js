...
var log = getLogger('swissdata-user-field');
var SwissdataUserField = /** @class */ (function () {
    ...
    SwissdataUserField.prototype.processProperty = function () {
        var rightInstance = this._instance instanceof UserModel;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, this.swissdataApi.put('/auth/password-change', body).then(jsonify)];
                    case 4:
                        _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.swissdataApi.put('/auth/request-email-change', body).then(jsonify)];
                    case 3:
                        token = _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.swissdataApi.put('/auth/validate-email-change', body).then(jsonify)];
                    case 2:
                        user = _a.sent();
                        this.token = '';
                        this.code = '';
    ...
    SwissdataUserField.prototype.requestMobileChange = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        intMobile = new PhoneNumber(this.mobile, this.swissdataApi.state.country.toLowerCase()).getNumber();
                        body = {
                            mobile: intMobile
                        };
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.swissdataApi.put('/auth/request-mobile-change', body).then(jsonify)];
                    case 2:
                        token = _a.sent();
                        this.token = token.token;
                        return [3 /*break*/, 4];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.swissdataApi.put('/auth/validate-mobile-change', body).then(jsonify)];
                    case 2:
                        user = _a.sent();
                        this.token = '';
                        this.code = '';
    ...
    SwissdataUserField.prototype.notify = function () {
        var customEvent = DOM.createCustomEvent('changed', { bubbles: true });
...
export { SwissdataUserField };
export function updateUser(state, user, properties) {
