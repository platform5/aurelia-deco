...
var Dico = /** @class */ (function () {
    ...
    Dico.prototype.fetchNbDico = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, DicoModel.getAll("?limit=1&skip=0", { includeResponse: true })];
                    case 1:
                        items = _b.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.global.swissdataApi.get("/dico/contexts").then(jsonify)];
                    case 1:
                        contexts = _a.sent();
    ...
    Dico.prototype.addUserWhereMissing = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, DicoModel.getAll("?_createdBy=", { includeResponse: true })];
                    case 1:
                        items = _a.sent();
                        _i = 0, items_1 = items;
                        _a.label = 2;
    ...
    Dico.prototype.addCertifiedTag = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, DicoModel.getAll("", { includeResponse: true })];
                    case 1:
                        items = _a.sent();
                        _i = 0, items_2 = items;
                        _a.label = 2;
    ...
    Dico.prototype.getKeysWithoutHumanTranslation = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, DicoModel.getAll("?_createdBy=&locale=all", { includeResponse: true })];
