System.register([], function (exports_1, context_1) {
    "use strict";
    var RequestRecorder, RecordedRequest, RecordedResponse;
    var __moduleName = context_1 && context_1.id;
    return {
        setters: [],
        execute: function () {
            RequestRecorder = /** @class */ (function () {
            ...
            exports_1("RequestRecorder", RequestRecorder);
            RecordedRequest = /** @class */ (function () {
            ...
            exports_1("RecordedRequest", RecordedRequest);
            RecordedResponse = /** @class */ (function () {
                function RecordedResponse() {
                    this.headers = {};
                }
                return RecordedResponse;
            }());
            exports_1("RecordedResponse", RecordedResponse);
        }
    };
});
