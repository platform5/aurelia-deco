System.register(["./../models/profile.model", "./../models/user.model", "./sd-login", "./../models/dynamicconfig.model", "aurelia-event-aggregator", "aurelia-router", "aurelia-i18n", "./swissdata-api", "aurelia-dependency-injection", "aurelia-logging", "../models/dynamicdata.model", "../deco", "aurelia-store", "../state/actions", "rxjs/operators", "aurelia-resources", "moment"], function (exports_1, context_1) {
    "use strict";
    ...
    var profile_model_1, user_model_1, sd_login_1, dynamicconfig_model_1, aurelia_event_aggregator_1, aurelia_router_1, aurelia_i18n_1, swissdata_api_1, aurelia_dependency_injection_1, aurelia_logging_1, dynamicdata_model_1, deco_1, aurelia_store_1, actions_1, operators_1, aurelia_resources_1, moment, SwissdataGlobal;
    ...
    return {
        setters: [
            ...
            function (dynamicconfig_model_1_1) {
                dynamicconfig_model_1 = dynamicconfig_model_1_1;
            },
            ...
            function (dynamicdata_model_1_1) {
                dynamicdata_model_1 = dynamicdata_model_1_1;
            },
            function (deco_1_1) {
                deco_1 = deco_1_1;
            },
        ...
        execute: function () {
            SwissdataGlobal = /** @class */ (function () {
            ...
            exports_1("SwissdataGlobal", SwissdataGlobal);
        }
    };
});
