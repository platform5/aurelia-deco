System.register(["./authentication-control", "./swissdata-global", "./request-recorder", "aurelia-event-aggregator", "../deco", "aurelia-framework", "whatwg-fetch", "../state/actions", "aurelia-logging", "aurelia-router", "./i18n-setup"], function (exports_1, context_1) {
    "use strict";
    ...
    var authentication_control_1, swissdata_global_1, request_recorder_1, aurelia_event_aggregator_1, deco_1, aurelia_framework_1, actions_1, aurelia_logging_1, aurelia_router_1, i18n_setup_1, globalContexts, isGlobalDico, SwissdataApi, AuthorizeStep;
    var __moduleName = context_1 && context_1.id;
    return {
        setters: [
            function (authentication_control_1_1) {
                authentication_control_1 = authentication_control_1_1;
            },
            function (swissdata_global_1_1) {
                swissdata_global_1 = swissdata_global_1_1;
            },
        ...
        execute: function () {
            ...
            SwissdataApi = /** @class */ (function (_super) {
            ...
            exports_1("SwissdataApi", SwissdataApi);
            AuthorizeStep = /** @class */ (function () {
            ...
            exports_1("AuthorizeStep", AuthorizeStep);
        }
    };
});
