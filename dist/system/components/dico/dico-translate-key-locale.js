System.register(["../../models/dico.model", "aurelia-framework"], function (exports_1, context_1) {
    "use strict";
    ...
    var dico_model_1, aurelia_framework_1, DicoTranslateKeyLocale;
    ...
    return {
        ...
        execute: function () {
            DicoTranslateKeyLocale = /** @class */ (function () {
                ...
                DicoTranslateKeyLocale.prototype.setInstance = function () {
                    ...
                    for (var _i = 0, _a = this.allDicoItemsByLocale; _i < _a.length; _i++) {
                        ...
                        if (item.key === this.key) {
                            if (item.locales && item.locales[this.locale] && item.locales[this.locale] instanceof dico_model_1.DicoModel) {
            ...
            exports_1("DicoTranslateKeyLocale", DicoTranslateKeyLocale);
        }
    };
});
