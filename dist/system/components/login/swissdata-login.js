System.register(["aurelia-event-aggregator", "aurelia-framework", "@aurelia-ux/core", "../../helpers/swissdata-api", "../../models/user.model", "../../deco", "./swissdata-login-form-validation-renderer", "../notification/swissdata-notification", "aurelia-pal", "aurelia-resources", "awesome-phonenumber", "aurelia-validation", "../../state/actions", "aurelia-logging"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_event_aggregator_1, aurelia_framework_1, core_1, swissdata_api_1, user_model_1, deco_1, swissdata_login_form_validation_renderer_1, swissdata_notification_1, aurelia_pal_1, aurelia_resources_1, awesome_phonenumber_1, aurelia_validation_1, actions_1, aurelia_logging_1, SwissdataLogin, FilterCountriesValueConverter;
    ...
    return {
        setters: [
            ...
            function (swissdata_login_form_validation_renderer_1_1) {
                swissdata_login_form_validation_renderer_1 = swissdata_login_form_validation_renderer_1_1;
            },
        ...
        execute: function () {
            SwissdataLogin = /** @class */ (function () {
                function SwissdataLogin(element, styleEngine, eventAggregator, swissdataApi, forgotPasswordValidationController) {
                    ...
                    this.countries = aurelia_resources_1.countries;
                    ...
                    this.log = aurelia_logging_1.getLogger('swissdata-login');
                    this.forgotPasswordValidationController.trigger = aurelia_validation_1.validateTrigger.change;
                    deco_1.validate.ValidationRules
                        ...
                        var number = new awesome_phonenumber_1.default(value, _this.countryCode);
                        if (!number.isValid())
                            return false;
                    ...
                    this.forgotPasswordValidationController.addRenderer(new swissdata_login_form_validation_renderer_1.SwissdataLoginFormValidationRenderer());
                }
                ...
                SwissdataLogin.prototype.attached = function () {
                    ...
                    this.swissdataApi.isReady().then(function () {
                        ...
                        return _this.swissdataApi.store.dispatch(actions_1.setLoginStep, _this.step);
                    }).then(function () {
                        _this.fixInputs();
                ...
                SwissdataLogin.prototype.stepChanged = function () {
                    ...
                    if (this.step === 'create-account') {
                        if (!this.newAccountInstance) {
                            this.newAccountInstance = new user_model_1.UserModel();
                            deco_1.validate.ValidationRules
                            ...
                            this.newAccountInstance.validationController.addRenderer(new swissdata_login_form_validation_renderer_1.SwissdataLoginFormValidationRenderer());
                        }
                    ...
                    if (this.step === 'reset-password') {
                        this.swissdataApi.store.dispatch(actions_1.setSwissdataStateProps, { resetPasswordToken: this.resetPasswordToken });
                    ...
                    return this.swissdataApi.store.dispatch(actions_1.setLoginStep, this.step);
                };
                ...
                SwissdataLogin.prototype.login = function () {
                    ...
                    this.swissdataApi.authenticate(this.loginInput, this.loginPassword).then(function () {
                        ...
                        _this.processing = false;
                        swissdata_notification_1.errorHandler('login.login', { hideOnClick: false, clearHandlerWhenIntercepted: true })(error);
                    });
                };
                SwissdataLogin.prototype.doubleAuth = function () {
                    ...
                    this.swissdataApi.doubleAuth(this.doubleAuthCode).then(function () {
                        ...
                        _this.processing = false;
                        swissdata_notification_1.errorHandler('login.double-auth', { hideOnClick: false, clearHandlerWhenIntercepted: true })(error);
                    });
                };
                SwissdataLogin.prototype.loginOk = function () {
                    ...
                    this.eventAggregator.publish('swissdata-login', data);
                    var event = aurelia_pal_1.DOM.createCustomEvent('login', { bubbles: true, detail: data });
                ...
                SwissdataLogin.prototype.createAccount = function () {
                    ...
                    this.newAccountInstance.validationController.validate().then(function (result) {
                        ...
                        if (element.token) {
                            ...
                            return _this.swissdataApi.store.dispatch(actions_1.setSwissdataStateProps, { createAccountValidationToken: element.token, newAccountInstance: _this.newAccountInstance });
                        ...
                        _this.processing = false;
                        swissdata_notification_1.errorHandler('login.create-account', { hideOnClick: false, clearHandlerWhenIntercepted: true })(error);
                    });
                };
                SwissdataLogin.prototype.saveNewAccountInstanceInState = function () {
                    return this.swissdataApi.store.dispatch(actions_1.setSwissdataStateProps, { newAccountInstance: this.newAccountInstance });
                };
                ...
                */
                SwissdataLogin.prototype.selectCountry = function (country) {
                    ...
                    this.countrySelectorOpened = false;
                    this.countrySearchTerm = '';
                    this.countryPrefix = '+' + awesome_phonenumber_1.default.getCountryCodeForRegionCode(this.countryCode).toString();
                    this.phonePlaceholder = awesome_phonenumber_1.default.getExample(this.countryCode, 'mobile').getNumber('national');
                    var number = new awesome_phonenumber_1.default(this.newAccountInstance.mobile, this.countryCode);
                    if (!number.isValid()) {
                ...
                SwissdataLogin.prototype.saveNewAccountPhoneInState = function () {
                    this.swissdataApi.store.dispatch(actions_1.setSwissdataStateProps, { newAccountPhone: {
                ...
                SwissdataLogin.prototype.validateEmail = function () {
                    ...
                    if (!this.validateEmailCode || this.validateEmailCode.length !== 6) {
                        swissdata_notification_1.errorHandler('login.validate-email', { hideOnClick: false, clearHandlerWhenIntercepted: true })(new Error('The code must be 6 digits'));
                        return;
                    }
                    this.processing = false;
                    return this.newAccountInstance.validAccountCreationToken('email', this.swissdataApi.state.swissdata.createAccountValidationToken, this.validateEmailCode).then(function (element) {
                        ...
                        _this.processing = false;
                        swissdata_notification_1.errorHandler('login.validate-email', { hideOnClick: false, clearHandlerWhenIntercepted: true })(error);
                    });
                };
                SwissdataLogin.prototype.validateMobile = function () {
                    var _this = this;
                    if (!this.validateMobileCode || this.validateMobileCode.length !== 6) {
                        swissdata_notification_1.errorHandler('login.validate-mobile', { hideOnClick: false, clearHandlerWhenIntercepted: true })(new Error('The code must be 6 digits'));
                        return;
                    }
                    this.processing = false;
                    return this.newAccountInstance.validAccountCreationToken('mobile', this.swissdataApi.state.swissdata.createAccountValidationToken, this.validateMobileCode).then(function (element) {
                        ...
                        _this.processing = false;
                        swissdata_notification_1.errorHandler('login.validate-mobile', { hideOnClick: false, clearHandlerWhenIntercepted: true })(error);
                    });
                };
                SwissdataLogin.prototype.resendCode = function (method) {
                    return this.swissdataApi.put("/user/resend-code", {
                        ...
                        swissdata_notification_1.notifier('login.validate-' + method, { lifetime: 10000, hideOnClick: true })('', 'login.Your code has been sent again', 'confirmation');
                    }).catch(swissdata_notification_1.errorHandler('login.validate-' + method));
                };
                ...
                SwissdataLogin.prototype.goToAccountCreatedScreen = function () {
                    ...
                    return this.swissdataApi.store.dispatch(actions_1.setSwissdataStateProps, { createAccountValidationToken: '', newAccountInstance: null });
                };
                SwissdataLogin.prototype.requestResetPassword = function () {
                    ...
                    this.swissdataApi.requestResetPassword(forgotPasswordInput).then(function (token) {
                        ...
                        _this.swissdataApi.store.dispatch(actions_1.setSwissdataStateProps, { resetPasswordToken: _this.resetPasswordToken });
                        _this.processing = false;
                        _this.step = 'reset-password';
                    }).catch(function (error) {
                        _this.processing = false;
                        swissdata_notification_1.errorHandler('login.forgot-password', { hideOnClick: false, clearHandlerWhenIntercepted: true })(error);
                    });
                };
                ...
                SwissdataLogin.prototype.resetPassword = function () {
                    ...
                    this.swissdataApi.resetPassword(this.resetPasswordToken, this.resetPasswordCode, this.resetPasswordNewPassword).then(function () {
                        ...
                        _this.step = 'login';
                        setTimeout(function () {
                            swissdata_notification_1.notifier('login.login', { lifetime: 0, hideOnClick: false })('', 'login.Your password has been reset, you can now safely login with your new password', 'confirmation');
                        }, 200);
                    }).catch(function (error) {
                        _this.processing = false;
                        swissdata_notification_1.errorHandler('login.reset-password', { hideOnClick: false, clearHandlerWhenIntercepted: true })(error);
                    });
                };
                __decorate([
                ...
                __decorate([
                    aurelia_framework_1.computedFrom('countryCode')
                ], SwissdataLogin.prototype, "countryCodeFlag", null);
                SwissdataLogin = __decorate([
                    aurelia_framework_1.inject(Element, core_1.StyleEngine, aurelia_event_aggregator_1.EventAggregator, swissdata_api_1.SwissdataApi, aurelia_framework_1.NewInstance.of(aurelia_validation_1.ValidationController))
                ], SwissdataLogin);
                return SwissdataLogin;
            }());
            exports_1("SwissdataLogin", SwissdataLogin);
            FilterCountriesValueConverter = /** @class */ (function () {
            ...
            exports_1("FilterCountriesValueConverter", FilterCountriesValueConverter);
        }
    };
});
