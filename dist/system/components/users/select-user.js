System.register(["./../../models/user.model", "@aurelia-ux/modal", "aurelia-framework", "aurelia-resources", "aurelia-logging", "../../helpers/swissdata-api"], function (exports_1, context_1) {
    "use strict";
    ...
    var user_model_1, modal_1, aurelia_framework_1, aurelia_resources_1, aurelia_logging_1, swissdata_api_1, log, SelectUser;
    ...
    return {
        ...
        execute: function () {
            log = aurelia_logging_1.getLogger('select-user');
            SelectUser = /** @class */ (function () {
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            ...
                            if (!result.output && !this.userId) {
                                aurelia_resources_1.errorify(new Error('Select a user'));
                ...
                SelectUser = __decorate([
                    aurelia_framework_1.inject(swissdata_api_1.SwissdataApi, modal_1.UxModalService)
                ], SelectUser);
                return SelectUser;
            }());
            exports_1("SelectUser", SelectUser);
        }
    };
});
