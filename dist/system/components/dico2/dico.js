System.register(["@aurelia-ux/modal", "aurelia-framework", "aurelia-logging", "aurelia-resources", "../../models", "../../deco", "aurelia-fetch-client", "./dico-dialog"], function (exports_1, context_1) {
    "use strict";
    ...
    var modal_1, aurelia_framework_1, aurelia_logging_1, aurelia_resources_1, models_1, deco_1, aurelia_fetch_client_1, dico_dialog_1, log, googleApiKey, Dico;
    ...
    return {
        setters: [
            ...
            function (dico_dialog_1_1) {
                dico_dialog_1 = dico_dialog_1_1;
            }
        ],
        execute: function () {
            log = aurelia_logging_1.getLogger('dico');
            googleApiKey = 'AIzaSyAfTjyWuowZAAQWZ0t6dB8yyvJpq3HMAf4';
            Dico = /** @class */ (function () {
