System.register(["aurelia-framework", "../../helpers/swissdata-api", "aurelia-logging", "aurelia-pal", "../../deco", "../../models/user.model", "aurelia-resources", "aurelia-validation", "aurelia-i18n", "awesome-phonenumber"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_framework_1, swissdata_api_1, aurelia_logging_1, aurelia_pal_1, deco_1, user_model_1, aurelia_resources_1, aurelia_validation_1, aurelia_i18n_1, awesome_phonenumber_1, log, SwissdataUserField;
    ...
    exports_1("updateUser", updateUser);
    return {
        setters: [
        ...
        execute: function () {
            log = aurelia_logging_1.getLogger('swissdata-user-field');
            SwissdataUserField = /** @class */ (function () {
            ...
            exports_1("SwissdataUserField", SwissdataUserField);
        }
    };
});
