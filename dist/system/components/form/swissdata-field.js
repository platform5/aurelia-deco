System.register(["../../deco", "aurelia-framework", "aurelia-logging", "../../models"], function (exports_1, context_1) {
    "use strict";
    ...
    var deco_1, aurelia_framework_1, aurelia_logging_1, models_1, log, SwissdataField;
    ...
    return {
        ...
        execute: function () {
            log = aurelia_logging_1.getLogger('components:swissdata-field');
            SwissdataField = /** @class */ (function (_super) {
            ...
            exports_1("SwissdataField", SwissdataField);
        }
    };
});
