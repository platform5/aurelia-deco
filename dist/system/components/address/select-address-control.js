System.register(["./select-address-dialog", "aurelia-framework", "@aurelia-ux/modal", "aurelia-logging", "aurelia-pal"], function (exports_1, context_1) {
    "use strict";
    ...
    var select_address_dialog_1, aurelia_framework_1, modal_1, aurelia_logging_1, aurelia_pal_1, log, SelectAddressControl;
    var __moduleName = context_1 && context_1.id;
    return {
        setters: [
            function (select_address_dialog_1_1) {
                select_address_dialog_1 = select_address_dialog_1_1;
            },
        ...
        execute: function () {
            log = aurelia_logging_1.getLogger('select-address-control');
            SelectAddressControl = /** @class */ (function () {
            ...
            exports_1("SelectAddressControl", SelectAddressControl);
        }
    };
});
