System.register(["./../../decorators/address", "@aurelia-ux/modal", "aurelia-framework", "aurelia-resources", "aurelia-logging"], function (exports_1, context_1) {
    "use strict";
    ...
    var address_1, modal_1, aurelia_framework_1, aurelia_resources_1, aurelia_logging_1, log, SelectAddressDialog;
    ...
    return {
        ...
        execute: function () {
            log = aurelia_logging_1.getLogger('select-address-dialog');
            SelectAddressDialog = /** @class */ (function () {
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        return __generator(this, function (_a) {
                            ...
                            if (!result.output && !this.address) {
                                aurelia_resources_1.errorify(new Error('Select an address'));
                ...
                SelectAddressDialog.prototype.compareAddresses = function (a, b) {
                    return address_1.isSameAddress(a, b);
                };
            ...
            exports_1("SelectAddressDialog", SelectAddressDialog);
        }
    };
});
