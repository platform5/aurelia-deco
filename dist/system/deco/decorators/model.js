System.register(["aurelia-framework", "../helpers/deco-api", "aurelia-validation", "aurelia-resources", "aurelia-logging", "moment"], function (exports_1, context_1) {
    "use strict";
    var aurelia_framework_1, deco_api_1, aurelia_validation_1, aurelia_resources_1, aurelia_logging_1, moment, log, defaultModelOptions, model, Model;
    ...
    return {
        ...
        execute: function () {
            log = aurelia_logging_1.getLogger('decorators:model');
            defaultModelOptions = {
                enableStory: false
            };
            exports_1("model", model = function (baseroute, options) {
