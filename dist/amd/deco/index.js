...
define(["require", "exports", "./components/form/ad-dialog-model", "./components/form/ux-file-input", "./dialogs", "./decorators", "./helpers/deco-api", "./helpers/file-upload", "./helpers/ipstack", "./helpers/ensure-model", "./decorators/types", "./interfaces/deco", "./interfaces/file", "./state", "./components/ad-image", "./components/form/deco-field", "./components/ad-images", "./components/ad-images-theme", "aurelia-store"], function (require, exports, ad_dialog_model_1, ux_file_input_1, dialogs_1, decorators_1, deco_api_1, file_upload_1, ipstack_1, ensure_model_1, types_1, deco_1, file_1, state_1, ad_image_1, deco_field_1, ad_images_1, ad_images_theme_1, aurelia_store_1) {
    ...
    __exportStar(ux_file_input_1, exports);
