...
define(["require", "exports", "aurelia-resources", "aurelia-i18n", "aurelia-framework"], function (require, exports, aurelia_resources_1, aurelia_i18n_1, aurelia_framework_1) {
    "use strict";
                ...
                return __generator(this, function (_a) {
                    ...
                    if (this.checkAllValues) {
                        ...
                        if (!this.address.street || !this.address.zip || !this.address.city || !this.address.country) {
                            aurelia_resources_1.errorify(new Error('You must fill out all fields'));
