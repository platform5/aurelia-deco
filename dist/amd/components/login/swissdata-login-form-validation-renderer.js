define(["require", "exports"], function (require, exports) {
    ...
    exports.SwissdataLoginFormValidationRenderer = void 0;
    var SwissdataLoginFormValidationRenderer = /** @class */ (function () {
        function SwissdataLoginFormValidationRenderer() {
        }
        SwissdataLoginFormValidationRenderer.prototype.render = function (instruction) {
        ...
        SwissdataLoginFormValidationRenderer.prototype.add = function (element, result) {
            if (result.valid) {
                return;
            }
            element.classList.add('has-error');
            var container = element.closest('.input-container');
            if (!container) {
                return;
            }
            var inputInfoHintText = container.nextElementSibling;
        ...
        SwissdataLoginFormValidationRenderer.prototype.remove = function (element, result) {
            if (result.valid) {
                return;
            }
        ...
        return SwissdataLoginFormValidationRenderer;
    }());
    exports.SwissdataLoginFormValidationRenderer = SwissdataLoginFormValidationRenderer;
});
